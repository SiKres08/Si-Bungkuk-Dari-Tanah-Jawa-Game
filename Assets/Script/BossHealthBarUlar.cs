...
public class BossHealthBarUlar : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        healthBarText.text = "ULAR NAGA   " + bossDamageable.Health + "/" + bossDamageable.MaxHealth;
    }
    ...
    void OnPLayerHealChanged(int newHealth,  int maxHealth)
    {
        ...
        healthBarText.text = "ULAR NAGA  " + newHealth + "/" + maxHealth;
    }
}
